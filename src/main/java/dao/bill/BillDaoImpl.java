...
public class BillDaoImpl implements BillDao {
    ...
    public List<Bill> getBillList(Connection connection, Bill bill)
        ...
        if(connection != null){
            ...
            sql.append("select b.*,p.proName as providerName from smbms_provider p INNER JOIN smbms_bill b ON b.providerId = p.id");
    ...
    public Bill getBillById(Connection connection, String id) throws Exception {
        ...
        ResultSet rs = null;
        if(null != connection){
            String sql = "select b.*,p.proName as providerName from smbms_provider p " +
